...
export function SettingsPage() {
  ...
  const [smartTimerRingtone, setSmartTimerRingtone] = useState("soft_chime");
  const [smartTimerRingtoneRepeat, setSmartTimerRingtoneRepeat] = useState(1);

  useEffect(() => {
    void api("/api/settings").then((u) => {
      setS(u);
      setEmail(u.email);
      ...
      setSmartTimerRingtone(u.smartTimerRingtone ?? "soft_chime");
  ...
  async function save(e) {
    ...
    try {
      ...
      setSmartTimerRingtone(updated.smartTimerRingtone ?? "soft_chime");
