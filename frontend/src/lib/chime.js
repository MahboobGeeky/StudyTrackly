 ...
 */
export async function primeSoftChime(volume) {
...
function playToneSequence(volume, tones, repeats = 1) {
  ...
  for (let r = 0; r < repeats; r++) {
    ...
    for (const t of tones) {
      allTones.push({ freq: t.freq, start: t.start + offset, dur: t.dur });
    }
  }
...
export function playSoftChime(volume, repeats = 1) {
...
function playClassicBell(volume, repeats = 1) {
...
function playTriplePing(volume, repeats = 1) {
  playToneSequence(
    volume,
    [
...
function playAlertBeep(volume, repeats = 1) {
...
function playLongChime(volume, repeats = 1) {
...
function playDigitalAlarm(volume, repeats = 1) {
...
function playZenGong(volume, repeats = 1) {
...
export function playSmartTimerRingtone(ringtone, volume, repeats = 1) {
  switch (ringtone) {
    case "classic_bell":
